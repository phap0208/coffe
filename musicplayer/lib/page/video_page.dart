...
//     setState(() {
//       currentSongTitle = songs[_currentIndex].title ?? '';
//     });
//   }
//   @override
//   void initState() {
...
//       print("vvvvvvvvv");
//       // kiểm tra nếu chưa phát hết danh sách bài hát
//       setState(() async{
//         loading = true;
//         _currentIndex +=1 ;
//          _controller.removeListener(_onListen);
//         _controller.pause();
//        await _controller.dispose(); // loại bỏ bộ điều khiển hiện tại
//
//         initPlay();
//         updateCurrentSongTitle();// khởi tạo phát bài hát mới
//       });
...
//       setState(() {
//         _controller.dispose(); // Loại bỏ bộ điều khiển
//         _currentIndex = 0; // Reset chỉ số về 0
//         songs.removeAt(1); // Xóa bài hát đã phát xong khỏi danh sách
//         if (songs.isNotEmpty) {
//           // Nếu danh sách còn bài hát
//           initPlay();
//           updateCurrentSongTitle();// Phát bài hát tiếp theo
//         }
//       });
//     }
//   }
//
//   // initPlay(){
//   //   _controller = VideoPlayerController.networkUrl(Uri.parse(songs[_currentIndex].songUrl ??''))
//   //     ..addListener((){
//   //       if (!_controller.value.isPlaying &&
...
//       updateCurrentSongTitle();// khởi tạo phát bài hát mới
//     });
//     // print("urlllllll ${Uri.parse(songs[_currentIndex].songUrl!)}");
//     // _controller = VideoPlayerController.networkUrl(
//     //     Uri.parse(songs[_currentIndex].songUrl!))
...
//         appBar: AppBar(
//           title: Text(currentSongTitle.isEmpty ? 'Video Player' : 'Đang phát: $currentSongTitle'),
//           centerTitle: true,
//         ),
//         body: Column(
//           children: [
...
//                               semanticLabel: songs[index].title,
//                               fit: BoxFit.contain,
//                             ),
//                           ),
